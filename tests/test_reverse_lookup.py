...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            ReverseLookupResult("https://docs.python.org/3/library/os.html", "python", "std:doc", "library/os", None, False),
        ...
        (
            ...
            ReverseLookupResult("https://docs.python.org/3/library/os.html#module-os", "python", "py:module", "os", None, False),
        ...
        (
            ...
            ReverseLookupResult("https://devguide.python.org/getting-started/setup-building/", "devguide", "std:doc", "getting-started/setup-building", None, False),
            ReplacementContext(
        ...
        (
            ...
            ReverseLookupResult("https://docs.python.org/3/howto/free-threading-python.html", "python", "std:doc", "howto/free-threading-python", None, False),
            ReplacementContext(
